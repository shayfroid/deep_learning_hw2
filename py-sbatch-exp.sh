...
python -m hw2.experiments run-exp -n exp1_2_L2_K32 -K 32 -L 2 -P 2 -H 100
python -m hw2.experiments run-exp -n exp1_2_L2_K64 -K 64 -L 2 -P 2 -H 100
python -m hw2.experiments run-exp -n exp1_2_L2_K128 -K 128 -L 2 -P 2 -H 100
python -m hw2.experiments run-exp -n exp1_2_L2_K256 -K 256 -L 2 -P 2 -H 100

python -m hw2.experiments run-exp -n exp1_2_L4_K32 -K 32 -L 4 -P 2 -H 100
python -m hw2.experiments run-exp -n exp1_2_L4_K64 -K 64 -L 4 -P 2 -H 100
python -m hw2.experiments run-exp -n exp1_2_L4_K128 -K 128 -L 4 -P 2 -H 100
python -m hw2.experiments run-exp -n exp1_2_L4_K256 -K 256 -L 4 -P 2 -H 100

python -m hw2.experiments run-exp -n exp1_2_L8_K32 -K 32 -L 8 -P 2 -H 100
python -m hw2.experiments run-exp -n exp1_2_L8_K64 -K 64 -L 8 -P 2 -H 100
python -m hw2.experiments run-exp -n exp1_2_L8_K128 -K 128 -L 8 -P 2 -H 100
python -m hw2.experiments run-exp -n exp1_2_L8_K256 -K 256 -L 8 -P 2 -H 100
